...
Components include a recent mainline version of Nginx (mainline (1.25.x)) using configurations from the HTML 5 Boilerplate team (*and modified/customized for use with mainline*), Varnish 7.2.x, and MariaDB 10.6.x (drop-in replacement for MySQL), PHP8.3, PHP8.1, PHP7.4 or HHVM 4.x **new** (users choice), Sendmail (PHP mail function), CSF (Config Server Firewall), Wordpress and more to be added soon. (see [To-Do List](#the-to-do-list-back-to-top))
...
- Adds repositories for the latest stable versions of MariaDB (10.6.x), mainline (1.25.x) versions of Nginx, and Varnish 7.2.x.
