...
wget https://github.com/JMSDOnline/vstacklet-server-configs/archive/v0.3-alpha.zip >/dev/null 2>&1;
unzip -qq v0.3-alpha.zip
mv vstacklet-server-configs-0.3-alpha /etc/nginx >>"${OUTTO}" 2>&1;
...
rm /etc/nginx/conf.d/$sitename.conf.bak
